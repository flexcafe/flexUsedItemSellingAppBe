...
6. Admin checks GET /admin/dashboard/auth/kbzpay/verification-requested and sends instruction with POST /admin/dashboard/auth/kbzpay/:userId/send-instruction using adminPhoneForTransfer (optional adminNote can be included).
